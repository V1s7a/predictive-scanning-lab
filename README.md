...
The figure is produced from `results/budget_sweep_weighted.csv` (generated by the plotting snippet in the README) and saved as `results/coverage_vs_probes_weighted.png`.
